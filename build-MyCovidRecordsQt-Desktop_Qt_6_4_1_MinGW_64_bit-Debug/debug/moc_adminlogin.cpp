...
#include <memory>
#include "../../MyCovidRecordsQt/adminlogin.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AdminLogin_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AdminLogin_t qt_meta_stringdata_AdminLogin = {
    {
        QT_MOC_LITERAL(0, 10),  // "AdminLogin"
        QT_MOC_LITERAL(11, 21),  // "on_adminlogin_clicked"
        QT_MOC_LITERAL(33, 0),  // ""
        QT_MOC_LITERAL(34, 24)   // "on_adminregister_clicked"
    },
    "AdminLogin",
...
Q_CONSTINIT static const uint qt_meta_data_AdminLogin[] = {
...
Q_CONSTINIT const QMetaObject AdminLogin::staticMetaObject = { {
    ...
    qt_meta_stringdata_AdminLogin.offsetsAndSizes,
...
void AdminLogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_adminlogin_clicked(); break;
        case 1: _t->on_adminregister_clicked(); break;
        default: ;
        }
    }
    (void)_a;
